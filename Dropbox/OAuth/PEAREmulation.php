 ...
 */
require dirname(__FILE__).'/../AbstractOAuth.php';

class Dropbox_OAuth_PEAREmulation extends Dropbox_AbstractOAuth {
    ...
    public function __construct($consumerKey, $consumerSecret) {
        ...
        if (!class_exists('HTTP_OAuth_Consumer',false)) {
            ...
            include 'PEAREmulation/HTTP/OAuth/Consumer.php';
